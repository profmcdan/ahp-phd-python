...
from library.hierarchy.ahpcriterion import AHPCriterion
from library.methods import EigenvalueMethod
from library.utils import normalize_priorities
...
class AHPModel:
    ...
    def __init__(self, model, solver=EigenvalueMethod):
        ...
        self.criteria = [AHPCriterion(n, model, solver=solver)
                         for n in criteria]
    ...
    def get_priorities(self, round_results=True, decimals=3):
        ...
        crit_attr_pr = [criterion.get_priorities()
