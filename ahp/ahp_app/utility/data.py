...
SBC2 = [
    ...
    [[0.1429,0.1667,0.2], [1,1,1], [0.2,0.125,0.3333], [6,7,8]],
    [[6,7,8], [3,4,5], [1,1,1], [7,8,9]],
    [[0.3333,0.5,1], [0.125,0.1429,0.1667], [0.111, 0.125, 0.149], [1,1,1]]
]

SBC3 = [
    [[1,1,1], [4,5,6], [0.1667,0.2,0.25]],
    [[0.1667,0.2,0.25], [1,1,1], [7,8,9]],
    [[4,5,6], [0.111, 0.125, 0.149], [1,1,1]]
]

SBC4 = [
    [[1,1,1], [8,9,9], [0.3333,0.5,1], [7,8,9], [6,7,8]],
    [[0.1111,0.1111,0.125], [1,1,1], [0.125,0.1429,0.1667], [4,5,6], [0.1667,0.2,0.25]],
    [[1,2,3], [6,7,8], [1,1,1], [8,9,9], [1,1,1], [0.25, 0.333, 0.5]],
    [[0.111, 0.125, 0.149], [0.1667,0.2,0.25], [0.1111,0.1111,0.125], [1,1,1], [5,6,7]],
    [[0.111, 0.125, 0.149], [4,5,6], [2,3,4], [0.1429, 0.1667, 0.2], [1,1,1]]
]


SBC5 = [
    [[1,1,1], [2,3,4], [4,5,6], [8,9,9]],
    [[0.25, 0.333, 0.5], [1,1,1], [0.1429,0.1667,0.2], [1,2,3]],
    [[0.1667,0.2,0.25], [5,6,7], [1,1,1], [7,8,9]],
    [[0.1111,0.1111,0.125], [0.3333,0.5,1], [0.111, 0.125, 0.149], [1,1,1]]
]


ALT1 = [
    [[1,1,1], [2,3,4], [0.1111,0.1111,0.125]],
    [[0.25, 0.333, 0.5], [1,1,1], [5,6,7]],
    [[8,9,9], [0.1429,0.1667,0.2], [1,1,1]],
]

ALT2 = [
    [[1,1,1], [7,8,9], [0.1667,0.2,0.25]],
    [[0.111, 0.125, 0.149], [1,1,1], [0.111, 0.125, 0.149]],
    [[4,5,6], [7,8,9], [1,1,1]],
]

ALT3 = [
    [[1,1,1], [7,8,9], [3,4,5]],
    [[0.111, 0.125, 0.149], [1,1,1], [0.3333,0.5,1]],
    [[0.2,0.25,0.3333], [1,2,3], [1,1,1]], 
]


ALT4 = [
    [[1,1,1], [1,1,1], [0.2,0.25,0.3333]],
    [[1,1,1], [1,1,1],[8,9,9]],
    [[3,4,5], [0.1111,0.1111,0.125], [1,1,1]],
]

ALT5 = [
    [[1,1,1], [0.1667,0.2,0.25], [8,9,9]],
    [[4,5,6], [1,1,1], [2,3,4]],
    [[0.1111,0.1111,0.125], [0.25, 0.333, 0.5], [1,1,1]],
]

ALT6 = [
    [[1,1,1], [3,4,5], [5,6,7]],
    [[0.2,0.25, 0.333], [1,1,1], [0.2,0.25, 0.333]],
    [[0.1429,0.1667,0.2], [3,4,5], [1,1,1]],
]

ALT7 = [
    [[1,1,1], [8,9,9], [1,2,3]],
    [[0.1111,0.1111,0.125], [1,1,1], [1,1,1]],
    [[0.3333, 0.5,1], [1,1,1], [1,1,1]],
]

ALT8 = [
    [[1,1,1], [8,9,9], [0.1111,0.1111,0.125]],
    [[0.1111,0.1111,0.125], [1,1,1], [7,8,9]],
    [[8,9,9], [0.1111,0.125,0.1429], [1,1,1]],
]

ALT9= [
    [[1,1,1], [0.1667,0.2,0.25], [2,3,4]],
    [[4,5,6], [1,1,1], [8,9,9]],
    [[0.25,0.3333,0.5], [0.1111,0.1111,0.125], [1,1,1]],
]

ALT10 = [
    [[1,1,1], [4,5,6], [2,3,4]],
    [[0.1667,0.2,0.25], [1,1,1], [0.125,0.1429,0.1667]],
    [[0.3333, 0.5,1], [6,7,8], [1,1,1]],
]

ALT11 = [
    [[1,1,1], [0.1111,0.1111,0.125], [5,6,7]],
    [[8,9,9], [1,1,1], [2,3,4]],
    [[0.1429,0.1667,0.2], [0.3333, 0.5,1], [1,1,1]],
]

ALT12 = [
    [[1,1,1], [0.3333, 0.5,1], [6,7,8]],
    [[1,2,3], [1,1,1], [0.2,0.25,0.3333]],
    [[0.125,0.1429,0.1667], [3,4,5], [1,1,1]],
]

ALT13 = [
    [[1,1,1], [5,6,7], [0.2,0.25,0.3333]],
    [[0.1429,0.1667,0.2], [1,1,1], [1,1,1]],
    [[3,4,5], [1,1,1], [1,1,1]],
]

ALT14 = [
    [[1,1,1], [0.1667,0.2,0.25], [2,3,4]],
    [[4,5,6], [1,1,1], [0.2,0.25,0.3333]],
    [[0.25,0.3333,0.5], [3,4,5], [1,1,1]],
]
...
# Collate the data 
CRITERIA_MATRIX = C
SUBCRITERIA_MATRIX = [SBC1, SBC2, SBC3, SBC4, SBC5]
ALTERNATIVE_MATRIX = [ALT1, ALT2, ALT3, ALT4, ALT5, ALT6, ALT7, ALT8, ALT9, 
                      ALT10, ALT11, ALT12, ALT13, ALT14, ALT9, ALT10, ALT11, ALT12, ALT13, ALT14]

bid_price = [18000000, 15000000, 22000000]
estimated_price = 25000000
threshold = 2
contractor_names = ['AB Group', 'God,s Way Group', 'Glory of God Group']

model = AHPModel(CRITERIA_MATRIX, SUBCRITERIA_MATRIX, ALTERNATIVE_MATRIX)
# result = model.get_global_weight()
result = model.evaluate(bid_price, estimated_price, threshold, contractor_names)
print(result)
